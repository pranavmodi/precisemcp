#!/usr/bin/env python3
"""
MCP HTTP Client Application

This client connects to an independent MCP server via HTTP/SSE transport.
"""
...
async def main():
    ...
    # Connect to the independent MCP server via SSE
    ...
    try:
        async with sse_client(server_url) as (read, write):
            async with ClientSession(read, write) as session:
                ...
                print("✅ Connected to independent MCP Server!")
                ...
                print("🎉 MCP HTTP Client demonstration complete!")
